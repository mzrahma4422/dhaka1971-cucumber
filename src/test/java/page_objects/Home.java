...
public class Home extends NavigationBar {
    ...
    public Home typeHoi(String value) {
        LOGGER.debug("Entered home insurance  is: " + value);
    ...
    public Home typeHoa(String value) {
        LOGGER.debug("Entered monthly hoa is: " + value);
    ...
    public Home clickOnCalculateButton() {
        LOGGER.debug("clicked on the calculator button");
        ActOn.element(driver, Calculate).click();
        return this;
    }

    // Validating that total monthly payment accurate
